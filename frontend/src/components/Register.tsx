  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto overflow-hidden rounded-lg">
        ...
        >
          <div className="relative p-10 flex flex-col h-full justify-center items-center z-10 text-white">
            <h1 className="text-4xl font-bold mb-4 text-indigo-700 text-center">
              One Step Closer to
              <br />
              Your Dream
            </h1>
            <p className="mb-6 text-black font-bold text-center">
        ...
        <div className="w-full md:w-1/2 bg-indigo-900 p-10 flex flex-col justify-center">
                ...
                {showPassword ? (
                  ...
                  >
                    <path
                      ...
                      strokeWidth="2"
                      d="M15 12a3 3 0 11-6 0 3 3 0 016 0zm1.47 3.97A9.97 9.97 0 0021 12a9.97 9.97 0 00-4.53-7.97M9.53 4.03A9.97 9.97 0 003 12a9.97 9.97 0 004.53 7.97m9.94 0A9.97 9.97 0 003 12a9.97 9.97 0 004.53-7.97"
                    />
                  </svg>
                ) : (
                  <svg
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M13.875 18.825A10.022 10.022 0 0112 19c-5.523 0-10-4.477-10-10 0-1.902.53-3.678 1.46-5.175m7.036 7.036A3 3 0 1112 5m4.536 4.536A9.978 9.978 0 0121 12a9.978 9.978 0 01-2.464 6.464m-3.929-3.929A3 3 0 1112 19"
                    />
                  </svg>
                )}
              </button>
          ...
          <div className="mt-8 text-center">
            <p className="text-white">
              ...
              <a
                href="/login"
                className="ml-2 text-white hover:text-yellow-300 font-medium"
              >
                Login
              </a>
            </p>
