...
const AdminDashboard: React.FC = () => {
  ...
  const leftColumnNotifications: NotificationItem[] = [
    ...
    },
    {
      ...
      message: "John Doe was added to the admin group.",
      time: "30 mins ago",
    },
    {
      title: "Backup Completed",
      message: "The weekly backup was completed.",
      time: "3 hours ago",
    },
    {
      title: "New Feature",
    ...
    {
      title: "New Policy",
      message: "Updated privacy policy is now in effect.",
      time: "8 hours ago",
    },
  ];
  ...
  const rightColumnNotifications: NotificationItem[] = [
    ...
    {
      title: "Server Reboot",
      message: "Server will reboot in 5 mins.",
      time: "4 hours ago",
    },
    {
    ...
    },
    {
      ...
      message: "Email service is back online.",
      time: "10 hours ago",
    },
  ];
    ...
    <div className="min-h-screen bg-white">
      <header className="bg-indigo-900 text-white py-3 px-4 flex items-center justify-between">
        ...
        <div className="flex items-center w-full md:w-auto">
          <img src="/Logo.ico" alt="" width={40} />
          <h1 className="ml-4 text-3xl font-extrabold  tracking-wide">
            Einfratech
          </h1>
          {/* Mobile Menu Button */}
          <button
        ...
        <div className="hidden md:flex items-center space-x-4 text-white">
          ...
          <div className="relative">
            <input
              type="text"
              placeholder="Search"
              className="py-1 px-3 pr-8 rounded text-sm text-white placeholder-white"
            />
            <Search className="absolute right-2 top-1.5 h-4 w-4 text-white" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="border rounded-lg p-4 bg-white shadow-sm">
            <div className="h-32 bg-gray-100 rounded mb-2 flex items-center justify-center overflow-hidden">
              <img
                src={interactionRate}
                alt="Interaction rate chart"
                className="w-full h-full object-cover"
              />
            </div>
            <h3 className="font-semibold">Interaction Rate</h3>
            <p className="text-sm text-gray-600">
              Increased interactions by 25%
            </p>
            <p className="text-xs text-gray-500">Last compared: 2 days ago</p>

            {/* Pagination */}
            <div className="flex items-center justify-center mt-2">
              <button className="h-6 w-6 rounded-full bg-indigo-600 text-white flex items-center justify-center mr-1">
                1
              </button>
              <button className="h-6 w-6 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center mr-1">
                2
              </button>
              <button className="h-6 w-6 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center mr-1">
                3
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="w-full max-w-md mb-8">
            <h2 className="text-lg font-semibold mb-1 text-center">
              Current Enrollment - 46 Students
            </h2>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="border rounded-lg p-4 bg-white shadow-sm">
              <div className="h-40 bg-gray-100 rounded mb-4 flex items-center justify-center">
                <img
                  src={coursedropout}
                  alt="Drop-out rates heatmap"
                  className="w-full h-full object-cover rounded"
                />
              </div>

              <p className="text-sm text-gray-700">
                Based on the analysis, consider the following suggestions to
                improve course engagement and completion rates: Enhance course
                content interactivity, increase the number of assessments to
                gauge understanding, and provide additional resources for
                challenging topics.
              </p>
            </div>
          </div>
        ...
        <div className="p-4 bg-white rounded-lg shadow-md w-full">
          ...
          <div className="border-b pb-2 mb-2 mt-3 overflow-x-auto">
            <ul className="flex space-x-6 sm:space-x-20 text-sm whitespace-nowrap">
              <li className="font-medium text-indigo-600 cursor-pointer">
                Manage Subscription
              </li>
              <li className="font-medium text-indigo-600 cursor-pointer">
                Course Revenue
              ...
              <tbody>
                {courseRevenueData.map((course, index) => (
                  <tr key={index} className="border-b">
                    ...
                    <td>{course.user}</td>
                    <td>{course.transactionDate}</td>
                    <td>{course.amount}</td>
                    <td>
                      <button className="bg-indigo-600 text-white py-1 px-3 rounded text-xs">
                        View Details
                      </button>
                    </td>
                  </tr>
                    ...
                    <td>
                      <div
                        className={`h-6 w-6 rounded-full ${
                          sub.userType === 2 ? "bg-green-500" : "bg-purple-500"
                        }`}
                      ></div>
                    </td>
      ...
      <footer className="border-t py-3 px-4 sm:px-6 flex flex-col sm:flex-row justify-center sm:justify-end items-center text-sm text-gray-600">
        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
          ...
          <div className="flex space-x-2">
            <button className="text-indigo-600 font-medium bg-transparent hover:text-indigo-800">
              All
            </button>
            <button className="text-gray-800 bg-transparent hover:text-gray-600">
              Comments
            </button>
            <button className="text-gray-800 bg-transparent hover:text-gray-600">
              Assignments
