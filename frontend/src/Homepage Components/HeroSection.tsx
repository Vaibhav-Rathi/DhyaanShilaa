      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-16 py-16 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
          ...
          <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            className="bg-yellow-400 hover:bg-yellow-500 text-indigo-900 font-medium px-6 py-3 rounded">
              Explore Courses
            </button>
            <button
            onClick={() => navigate('/login')}
            className="border border-white text-white hover:bg-white hover:text-indigo-900 font-medium px-6 py-3 rounded transition">
              Start Learning Free
            </button>
          </div>
        </div>
