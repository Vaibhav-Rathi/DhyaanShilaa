  ...
  return (
    <section className="py-16 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl flex justify-center font-bold text-gray-900 mb-8">
          What They Say About<div className="ml-2 mr-2 text-blue-500">DhyaanShilaa</div> Courses
        </h2>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-lg shadow-lg max-w-sm transition-all duration-500 transform hover:scale-105"
            >
